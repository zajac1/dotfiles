...
vim.keymap.set("n", "<C-d>", "<C-d>zz", { desc = 'Move down half screen and center' })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { desc = 'Move up half screen and center' })
...
vim.api.nvim_create_autocmd('TermOpen', {
    callback = function()
        ...
        if ft ~= "snacks_terminal" and ft ~= "lazygit" then
